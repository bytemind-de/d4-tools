...
var damageReductionLabelsList = [
	...
	{label: "DR from ", group: "", types: []},
	{label: "DR from Bleeding", group: "", types: []},
	{label: "DR from Burning", group: "", types: []},
	{label: "DR from CC", group: "", types: []},
	{label: "DR from Chilled", group: "", types: []},
	{label: "DR from Close", group: "", types: []},
	{label: "DR from Distant", group: "", types: []},
	{label: "DR from Elites", group: "", types: []},
...
var pctMoreDamageTakenLabelsList = [
	{label: "Passive: Glass Cannon", group: "Sorc", types: []}
];
//TODO: add more